...
class FFPlay {
  public:
    ...
    // Returns true if OpenPlayer() was successful and there is not a matching
    // ClosePlayer() call. This flag does not reliably convey whether the
    // underlying subprocess is running or not.
    bool is_playing() const { return is_playing_; }

    // FFPlay options. Refer to https://ffmpeg.org/ffplay.html#toc-Main-options.
    FFPlay* width(std::optional<int> width) {
        width_ = width;
        return this;
    }
    FFPlay* height(std::optional<int> height) {
        height_ = height;
        return this;
    }
    FFPlay* fullscreen(bool fullscreen) {
        fullscreen_ = fullscreen;
        return this;
    }

    FFPlay* disable_video(bool disable_video) {
        disable_video_ = disable_video;
        return this;
    }
    FFPlay* disable_audio(bool disable_audio) {
        disable_audio_ = disable_audio;
        return this;
    }
    FFPlay* disable_subtitles(bool disable_subtitles) {
        disable_subtitles_ = disable_subtitles;
        return this;
    }

    FFPlay* start_pos(std::optional<std::chrono::milliseconds> start_pos) {
        start_pos_ = start_pos;
        return this;
    }
    FFPlay* duration(std::optional<std::chrono::milliseconds> duration) {
        duration_ = duration;
        return this;
    }

    FFPlay* left_pos(std::optional<int> left_pos) {
        left_pos_ = left_pos;
        return this;
    }
    FFPlay* top_pos(std::optional<int> top_pos) {
        top_pos_ = top_pos;
        return this;
    }

    // While the video is playing, display the current timestamp.
    FFPlay* enable_timestamp(bool enable_timestamp) {
